...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      chunks: ['app', 'assest/js/banner', 'assets/js/chart', 'assets/js/tabs']
    }),
    new HtmlWebpackPlugin({
    ...
    new HtmlWebpackPartialsPlugin({
      ...
      location: 'help',
      template_filename: ['index.html','add-product.html','products.html','orders.html'],
    }),
    new HtmlWebpackPartialsPlugin({
      path: path.join(__dirname, './src/components/banner.html'),
      location: 'banner',
      template_filename: ['banner.html'],
    }),
    new HtmlWebpackPartialsPlugin({
